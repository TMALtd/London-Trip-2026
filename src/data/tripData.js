export const tripData = {
  ...
  itinerary: [
    {
      ...
      type: "travel",
      highlights: ["Airport arrival", "Hotel transfer", "Settling in and group briefing"],
    },
    {
      day: "Day 2",
      date: "6 Nov",
    ...
    },
    {
      day: "Day 4",
      date: "8 Nov",
      title: "Science and Natural History",
      icon: "/itinerary/day-4-icon.svg",
      type: "learning",
      highlights: ["Science Museum", "Natural History Museum"],
    },
    {
      day: "Day 5",
      date: "9 Nov",
    ...
    },
    {
      day: "Day 8",
      date: "12 Nov",
      title: "Free time and return flight",
      icon: "/itinerary/day-8-icon.svg",
      type: "travel",
      highlights: ["Supervised free time", "Airport transfer", "Return to Kuala Lumpur"],
    },
  ],
  learningTracks: [
    {
  ...
  travel: {
    ...
    flightTimeTips: [
      "Start adjusting to London time as soon as you board the aircraft.",
      "Sleep strategically during the second half of the flight to help reset your body clock.",
      "Download films, music, books, podcasts, or offline games before departure.",
      "Charge all devices fully and bring a power bank in cabin baggage only.",
      "Wear comfortable clothing and bring a hoodie or neck pillow for overnight rest.",
      "Walk around the cabin every few hours to improve circulation and reduce stiffness.",
      "Stretch regularly while seated, especially during the overnight section of the flight.",
      "Avoid excessive caffeine and energy drinks before trying to sleep.",
      "Eat light meals and drink water regularly throughout the journey.",
      "Keep important items in cabin baggage, including medication, chargers, travel documents, and a spare t-shirt.",
    ],
    jetLagRecoveryTips: [
      "Stay awake until local bedtime on the first evening in London.",
      "Spend time outdoors in daylight to help reset your body clock faster.",
      "Avoid long daytime naps after arrival.",
      "Keep moving and stay active during the first full day.",
      "Drink plenty of water after landing and throughout the first 24 hours.",
      "Eat meals according to London time immediately after arrival.",
      "Shower and change clothes once at the hotel to help your body feel reset.",
      "Limit screen time late at night during the first two evenings.",
      "Expect to feel tired on the first day. This is normal during long-haul travel.",
      "Most students adjust fully within 2 to 3 days.",
    ],
    londonWeather: [
